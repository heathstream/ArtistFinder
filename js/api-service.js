...
export function musicGroupService(url) {
    ...
    this.readMusicGroupsAsync = async (pageNr, pageSize, filter = null, seeded = true) => await this._readItemsAsync(`${this.url}/MusicGroups/Read`, pageNr, false, filter, pageSize, seeded);
